...
if (strlen($password)>=5) {
   ...
   $query="INSERT INTO patient(patient_id, name, gender, age, telephone, email, datetym, address, password)VALUES('$patient_id', '$name', '$gender', '$age', '$telephone', '$email', '$datetym', '$address', '$password')";
   $results=$db->query($query);
    if ($results==1) {
