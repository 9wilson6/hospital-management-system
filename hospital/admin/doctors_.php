...
<div class="display_area">
   <h2 class="heading--secondary">Result For <?php echo $doctor_id; ?> Search</h2>
<h1 class="text-dark text-right"><a href="registereDoctor.php" class="btn btn-primary
                         ">Register New Doctor</a></h1>
         <a href="doctors.php" class="btn btn-lg btn-success my-4">All Records</a>
<table class="table table-light">
  ...
  <tbody>
    <?php 
       ...
       $query="SELECT * FROM doctor where doctor_id like '$doctor_id%'";
