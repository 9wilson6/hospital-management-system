...
<div class="display_area">
  <h2 class="heading--secondary"> Nurses List</h2>
<h1 class="text-dark text-right"><a href="registerNurse.php" class="btn btn-primary">Register New Nurse</a></h1>
          <form action="nurses_.php" class="my-4" method="POST">
