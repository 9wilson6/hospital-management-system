...
<h1 class="text-dark text-right"><a href="registerPatient.php" class="btn btn-primary">Register New Patient</a></h1>
<form action="patients_.php" class="my-4" method="POST">
        <input type="text" class="search_field" pattern="\d*" name="id" placeholder="Patient Id">
